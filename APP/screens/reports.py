...
def main():
    ...
    indicators_df = load_data_from_db("SELECT DISTINCT kpi.id, kpi.kpi_name FROM tb_kpi AS kpi INNER JOIN tb_monthly_data AS data ON kpi.id = data.kpi_id ORDER BY kpi.kpi_name")
